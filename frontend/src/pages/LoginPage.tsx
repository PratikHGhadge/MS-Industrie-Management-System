...
import { LoginValidateYupSchema } from "../validations/validationSchemas.js";
import { LoginCredentials } from "../validations/validationSchemas.js";
            ...
            >
              ...
              <div className="flex items-center justify-between">
                <div className="text-sm">
                  <Link
                    to="/"
                    className="font-medium text-H1-text-color hover:text-black "
                  >
